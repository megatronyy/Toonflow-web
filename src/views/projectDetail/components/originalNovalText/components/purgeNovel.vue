          ...
          <t-tab-panel value="To2" label="第二步">
            ...
            <div style="margin-top: 16px; text-align: right">
              ...
              <t-button
                ...
                :disabled="selectedTextLength > 200000"
                :loading="nextLoading"
                @click="nextAndKeepNovel">
                下一步
              </t-button>
            </div>
          </t-tab-panel>
          <!-- 第三步：分析事件-->
          <t-tab-panel value="To3" label="第三步" :destroyOnHide="false">
...
async function handleBeforeUpload(file: UploadFile) {
  console.log("%c Line:249 🥐 file", "background:#93c0a4", file);
...
//下一步并保存小说
async function nextAndKeepNovel() {
